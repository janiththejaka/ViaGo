...
const Footer = () => {
  return (
    <footer className="bg-viago-black border-top border-secondary">
      <Container className="py-5">
        <Row className="g-4">
          <Col xs={12} sm={6} lg={6}>
            ...
            <p className="text-secondary mb-4" style={{ maxWidth: '400px' }}>
              Your trusted ride-sharing partner. Get where you need to go, safely and affordably.
            </p>
          </Col>

          <Col xs={6} sm={3} lg={3}>
            <h3 className="text-white h6 fw-semibold mb-3">Company</h3>
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><a href="#" className="text-secondary text-decoration-none">Press</a></li>
              <li className="mb-2"><a href="#" className="text-secondary text-decoration-none">Blog</a></li>
            </ul>
          </Col>

          <Col xs={6} sm={3} lg={3}>
            <h3 className="text-white h6 fw-semibold mb-3">Support</h3>
            <ul className="list-unstyled">
              <li className="mb-2"><a href="#" className="text-secondary text-decoration-none">Help Center</a></li>
              <li className="mb-2"><a href="#" className="text-secondary text-decoration-none">Safety</a></li>
        ...
        <Row className="border-top border-secondary mt-4 pt-4">
          <Col xs={12} md={6} className="text-center text-md-start mb-3 mb-md-0">
            <p className="text-secondary small mb-0">© 2025 ViaGO. All rights reserved.</p>
          </Col>
